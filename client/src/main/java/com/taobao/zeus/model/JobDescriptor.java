...
public class JobDescriptor implements Serializable {
	...
	private String sqlScript;//add by phenix
	...
	public JobDescriptor getCopy() {
		...
		jobDescriptor.setSqlScript(this.getSqlScript());//add by phenix
	...
	public enum JobRunType {
		MapReduce("main"), Shell("shell"), Hive("hive"), Hs2("hs2"), Groovy("groovy"),RdbSql("rdbsql"); //add by phenix
