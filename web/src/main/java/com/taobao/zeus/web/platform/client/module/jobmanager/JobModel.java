...
public class JobModel implements Serializable {
	...
	public static final String HS2 = "hs2 脚本";
	public static final String RDBSQL = "rdbsql 脚本";
	public static final String GROOVY = "groovy 脚本";
	...
	public JobModel copy() {
		...
		model.setSqlScript(getSqlScript());//add by phenix
