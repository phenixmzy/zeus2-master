...
//		public String getUid() {return "yangfei";};
		...
		public String getEmail() {return "inveno.admin@inveno.cn";};
		public String getName() {return "英威诺";};
		public String getPhone() {return "10086";};
		public String getUid() {return "inveno";};
	};
	@Id
	@GeneratedValue
	private Long id;
