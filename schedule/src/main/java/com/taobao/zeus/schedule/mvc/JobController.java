...
public class JobController extends Controller {
	...
	private void startNewJob(TriggerType type, JobDescriptor jobDescriptor,
		...
		//modify mzy in 2015.04.04
		history.setExecuteHost(jobDescriptor.getHost());
		ScheduleInfoLog.info("startNewJob jobdesc.id=" + jobDescriptor.getId() + ", jobdesc.host=" +jobDescriptor.getHost() + ", history.id"+history.getJobId()+",history.executehost="+history.getExecuteHost());
