...
public class RunningJobKeys {
	 ...
	 * 需要执行的sql文件路径
	 */
	public static final String RUN_SQL_PATH="sql.localfile";
	
	/**
	 * hs2需要执行的hive 语句文件路径
	 */
	public static final String RUN_HS2_PATH = "hs2.localfile";
	
	/**
	 * groovy脚本 文件路径
	 */
	public static final String RUN_GROOVY_PATH = "groovy.localfile";
