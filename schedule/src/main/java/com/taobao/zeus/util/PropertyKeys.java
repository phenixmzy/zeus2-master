...
public class PropertyKeys extends RunningJobKeys{
	...
	public static final String JOB_SQL_SRCIPT="job.sql.script";
	
	public static final String JOB_UDF_FILE_ID = "3";//add by phenix
	
	/**
	 * 运行类型，比如： shell  hive mapreduce java hs2
	 */
